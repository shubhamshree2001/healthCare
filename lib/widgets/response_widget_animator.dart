...
class ResponseWidgetsAnimator extends StatelessWidget {
  ...
  final Widget Function()? lazyLoaderWidget;
  ...
  const ResponseWidgetsAnimator(
      {Key? key,
        required this.apiCallStatus,
        required this.loadingWidget,
        required this.errorWidget,
        required this.successWidget,
        this.lazyLoaderWidget,
        this.holdingWidget,
        this.emptyWidget,
        this.refreshWidget,
  ...
  _getChild() {
    ...
    else if(apiCallStatus==ApiCallStatus.lazyLoader)
      {
        return lazyLoaderWidget;
      }
    else {
      return successWidget;
    }
