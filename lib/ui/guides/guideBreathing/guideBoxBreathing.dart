...
class GuidesBoxBreathingScreen extends GetView<GuidesAudioTemelateController> {
  const GuidesBoxBreathingScreen({Key? key}) : super(key: key);
  ...
  Widget tempelateBody() {
    return SafeArea(
      ...
      children: [
        Stack(
          children: [
            SvgPicture.asset(ImagesConstant.breathBox),
            SvgPicture.asset(ImagesConstant.circle)
          ],
        )
      ],
    ));
